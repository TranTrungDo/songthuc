...
if ( !function_exists('newsreaders_grid_post_widgets') ) :
     ...
     * @since 1.0.0
     */
    function newsreaders_grid_post_widgets(){
        // Grod Post widget.
        register_widget('Newsreaders_Sidebar_Grid_Style');

    }

endif;
add_action('widgets_init', 'newsreaders_grid_post_widgets');

// Grod Post widget
if ( !class_exists('Newsreaders_Sidebar_Grid_Style') ) :
     ...
     * @since 1.0.0
     */
    class Newsreaders_Sidebar_Grid_Style extends Newsreaders_Widget_Base
    {
        ...
        function __construct()
        {
            $opts = array(
                'classname' => '',
                'description' => esc_html__('Displays post form selected category specific for grid post in sidebars.', 'newsreaders'),
            ...
            parent::__construct( 'newsreaders-grid-post-layout', esc_html__('TWP: Grid Post Style', 'newsreaders'), $opts, array(), $fields );
        }
                ...
                <div class="nr-widget-section nr-widget-layout-1 nr-section-border">
                    <div class="wrapper">
                        ...
                        <?php if ( !empty( $params['title'] ) ) { ?>
                            <h2 class="nr-section-title nr-title-style-1"><?php echo esc_html($params['title']); ?></h2>
                        <?php } ?>

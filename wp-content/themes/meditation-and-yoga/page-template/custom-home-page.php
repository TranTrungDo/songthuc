		        ...
		        <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
		          	...
		          	<div class="carousel-caption">
			            <div class="inner_carousel">
			              	...
			              	<div class="read-btn">
				              	<a href="<?php esc_url(the_permalink());?>" class="" title="<?php esc_attr_e( 'Read More', 'meditation-and-yoga' ); ?>"><?php esc_html_e('Read More','meditation-and-yoga'); ?>
				              	</a>
				            </div>
			            </div>
		          	</div>
		...
		<div class="container">		
			<div class="service-box">
				<?php if( get_theme_mod('meditation_and_yoga_title') != ''){ ?>
		    		...
		    		<img src="<?php echo esc_url(get_theme_mod('meditation_and_yoga_border',get_template_directory_uri().'/assets/images/border.png')); ?>" alt="<?php esc_attr_e('Service Title Border Image', 'meditation-and-yoga'); ?>">
		    	<?php }?>
	            <div class="row">
		      		<?php
